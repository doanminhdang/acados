...
void print_matrix(char *file_name, const real_t *matrix, const int nrows,
    const int ncols) {
	int i,j;
    FILE *output;
...
void print_int_matrix(char *file_name, const int *matrix, const int nrows,
    const int ncols) {
	int i,j;
    FILE *output;
    if (strcmp(file_name, "stdout") == 0) {
...
void print_array(char *file_name, real_t *array, int size) {
    print_matrix(file_name, array, size, 1);
}

void print_int_array(char *file_name, const int *array, int size) {
