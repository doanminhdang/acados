...
volatile uint32_t g_ui32Timer0Counter = 0;
...
int main() {
    ...
    //
    // Use the flags to clear the LEDs
    //
...
//    // Use Timer0 for measuring time
//    //+ First, enable the timer:
//    SysCtlPeripheralEnable(SYSCTL_PERIPH_TIMER0);
//    //+ Second, configure the two 32-bit periodic timers.
//    TimerConfigure(TIMER0_BASE, TIMER_CFG_PERIODIC);
//    // TIMER_CFG_PERIODIC - Full-width periodic timer (default: count down)
//    TimerLoadSet(TIMER0_BASE, TIMER_A, g_ui32SysClock);
//    //+ Third, setup the interrupts for the timer timeouts.
//    IntEnable(INT_TIMER0A);
//    TimerIntEnable(TIMER0_BASE, TIMER_TIMA_TIMEOUT);
//    //+ Fourth, enable the timers.
//    TimerEnable(TIMER0_BASE, TIMER_A);
//    printf("Start Timer0 counter\n");

    //
    // Set SysTick timer to CLOCK_CONF_SECOND round per round.
    //
...
//  hpmpc_args.sigma_min = 1e-3;
    ...
    ************************************************/
    ...
    //
    // Toggle the flag of first LED to start measuring.
    //
    ...
    //
     // Toggle the flag of second LED to end measuring.
     //
